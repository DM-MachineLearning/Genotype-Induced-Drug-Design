...
def objective(trial):
    ...
    block_size = trial.suggest_int("block_size", 50, 300, step=50)
    z_dim = trial.suggest_categorical("z_dim", [32, 64])
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(
        ...
        study_name="cnn_vae_masking_tradeoff_2",
        storage="sqlite:///cnn_vae_masking_optuna_2.db",
        load_if_exists=True
    )
